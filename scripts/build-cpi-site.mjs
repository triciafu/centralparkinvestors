...
${body}
  ...
  <div id="shopify-section-sections--25978986234145__footer" class="shopify-section shopify-section-group-footer-group">
    <footer class="site-footer footer color-scheme-1 gradient section-sections--25978986234145__footer-padding">
      <div class="footer__custom page-width">
        <div class="footer__contact-band">
          <h2 class="footer__contact-heading">CONTACT</h2>
          <div class="footer__contact-copy rte">
        ...
        <div class="footer__custom-columns">
          <div class="footer__custom-column footer__custom-column--brand">
            <h3 class="footer__custom-title">CENTRAL PARK INVESTORS</h3>
            <div class="footer__custom-copy rte">
          ...
          <div class="footer__custom-column footer__custom-column--legal">
            <h3 class="footer__custom-title">LEGAL POLICIES</h3>
            <ul class="footer__custom-links list-unstyled">
              <li><a href="/pages/contact" class="footer__custom-link">Contact Us</a></li>
              <li><a href="/pages/privacy-policy" class="footer__custom-link">Privacy Policy</a></li>
              <li><a href="/pages/terms-and-conditions" class="footer__custom-link">Terms and Conditions</a></li>
            </ul>
          </div>

          <div class="footer__custom-column footer__custom-column--contact">
            <h3 class="footer__custom-title">CONTACT</h3>
            <div class="footer__custom-copy rte">
              <p><a href="mailto:contact@centralparkinvestors.com">ops@centralparkinvestors.com</a><br><br>Based in New York, NY and Miami Beach, FL.</p>
            </div>
          </div>
        </div>

        <div class="footer__copyright caption">
          <small class="copyright__content">© 2026 CENTRAL PARK INVESTORS</small>
        </div>
      </div>
    </footer>
    <style>#shopify-section-sections--25978986234145__footer p { font-size: 1em; }</style>
  </div>
